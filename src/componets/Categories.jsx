        ...
        <div>
            {
                ...
                ? 
                    <div></div>
                : 
                    <section id='categories' className="bg-white py-10">
                        <div className="container mx-auto flex items-center flex-wrap pt-4 pb-12">
...

                            {
                                ...
                                categorias.map(cat =>(
                                    ...
                                    <div className="w-full md:w-1/3 xl:w-1/4 p-6 flex flex-col" key={cat.idCategoria}>
                                        <Link to={`/categorias/${cat.idCategoria}`} className='shadow-2xl rounded-lg'>
