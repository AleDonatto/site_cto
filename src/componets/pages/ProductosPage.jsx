                    ...
                    <div className="container mx-auto px-6">
                        <div className="md:flex md:items-center">
                            <div className="w-full h-64 md:w-1/2 lg:h-96">
                                <img className="rounded-md object-cover mx-auto" src={`http://admin.ctodelpacifico.com/storage/${producto.image}`} alt={producto.nameProducto} style={dimension} />
                            </div>
                            <div className="w-full max-w-lg mx-auto mt-5 md:ml-8 md:mt-0 md:w-1/2">
                                ...
                                <div className="flex items-center mt-6">
                                    <button className="px-8 py-2 bg-indigo-600 text-white text-sm font-medium rounded hover:bg-indigo-500 focus:outline-none focus:bg-indigo-500">Ordenar en Tienda</button>
